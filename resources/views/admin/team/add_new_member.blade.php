        ...
        <div class="col-md-12 m-auto mt-2">
            <div class="card">
                <div class="card-body">
                    ...
                    @endif
                    <form class="form-horizontal p-t-20" method="post" action="{{route('save.member')}}" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group row">
                            <label for="memberName" class="col-sm-3 control-label">Member Name <span class="text-danger">*</span></label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="memberName" required name="member_name" placeholder="Name">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="InputDesignation" class="col-sm-3 control-label"> Member Designation <span class="text-danger">*</span></label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="InputDesignation" required name="designation" placeholder="designation">
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row m-b-0">
                            <div class="offset-sm-3 col-sm-9">
                                <button type="submit" class="btn btn-success waves-effect waves-light text-white">add a new member</button>
                            </div>
                        </div>
                    </form>
                </div>
