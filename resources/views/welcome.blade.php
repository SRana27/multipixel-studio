...
<head>
    <meta charset="utf-8">
    <title>welcome to multipixelstudio</title>
        ...
        <div class="d-flex justify-content-between topbar">
            <div class="top-info">
                <small class="me-3 text-white"><a href="#"><i
                            class="fas fa-map-marker-alt me-2 text-multipixel"></i></a>23 Ranking Street, New
                    York</small>
                <small class="me-3 text-white"><a href="#"><i class="fas fa-envelope me-2 text-multipixel"></i></a>Email@Example.com</small>
            </div>
            <div id="note" class="text-white d-none d-xl-flex"><small>Note : We help you to Grow your Business</small>
            </div>
            <div class="top-link">
                <a href="" title="discord" class="bg-light nav-fill btn btn-sm-square rounded-circle"><i
                        class="bi bi-discord text-multipixel"></i></a>
                <a href="" class="bg-light nav-fill btn btn-sm-square rounded-circle"><i
                        class="fab fa-facebook-f text-multipixel"></i></a>
                <a href="" class="bg-light nav-fill btn btn-sm-square rounded-circle"><i
                        class="fab fa-instagram text-multipixel"></i></a>
                <a href="" class="bg-light nav-fill btn btn-sm-square rounded-circle me-0"><i
                        class="fab fa-linkedin-in text-multipixel"></i></a>
            </div>
        </div>
    </div>
</div>
                ...
                <div class="navbar-nav ms-auto mx-xl-auto p-0">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu rounded ">
                            ...
                            <a href="client-comment.html" class=" dropdown-item">Testimonial</a>
                        </div>
                    </div>
                ...
                <div class="services-item bg-service">
                    <div class="p-4 text-center services-content">
                        <div class="services-content-icon">
                            <div class="mb-2">
                                <img src="img/videoedt.jpg" height="200px" width="100%" class="rounded">
                            </div>

                            <h4 class="mb-3 text-white">Video Editing</h4>
                            <p class="mb-4 text-white">Lorem ipsum dolor sit amet elit. Sed efficitur quis purus ut
                ...
                <div class="services-item bg-service">
                    <div class="p-4 text-center services-content">
                        <div class="services-content-icon">
                            ...
                            <div class="mb-2">
                                <img src="img/graphic.jpg" height="200px" width="100%" class="rounded">
                            </div>
                            <h4 class="mb-3 text-white">Graphic Design</h4>
                            <p class="mb-4 text-white">Lorem ipsum dolor sit amet elit. Sed efficitur quis purus ut
                                interdum. Aliquam dolor eget urna ultricies tincidunt.</p>
                            <a href="" class="btn bg-multipixeldeep text-white px-5 py-3 rounded-pill">Read More</a>
                        </div>
            ...
            <div class="col-md-6 col-lg-4 wow fadeIn" data-wow-delay=".3s">
                <div class="services-item bg-service">
                    <div class="p-4 text-center services-content">
                        <div class="services-content-icon">
                            <div class="mb-2">
                                <img src="img/animation.jpg" height="200px" width="100%" class="rounded">
                            </div>
                ...
                <div class="services-item bg-service">
                    <div class="p-4 text-center services-content">
                        <div class="services-content-icon">
                            ...
                            <div class="mb-2">
                                <img src="img/digital.jpg" height="200px" width="100%" class="rounded">
                            </div>
            ...
            <div class="col-md-6 col-lg-4 wow fadeIn" data-wow-delay=".7s">
                <div class="services-item bg-service">
                    <div class="p-4 text-center services-content">
                        <div class="services-content-icon">
                            <div class="mb-2">
                                <img src="img/logo-design-1.jpg" height="200px" width="100%" class="rounded">
                            </div>
                            <h4 class="mb-3 text-white">Logo Design</h4>
                            <p class="mb-4 text-white">Lorem ipsum dolor sit amet elit. Sed efficitur quis purus ut
                                interdum. Aliquam dolor eget urna ultricies tincidunt.</p>
                            <a href="" class="btn bg-multipixeldeep text-white px-5 py-3 rounded-pill">Read More</a>
                        </div>
            ...
            <div class="col-md-6 col-lg-4 wow fadeIn" data-wow-delay=".5s">
                <div class="services-item bg-service">
                    <div class="p-4 text-center services-content">
                        <div class="services-content-icon">
                            <div class="mb-2">
                                <img src="img/webdevelopment.jpg" height="200px" width="100%" class="rounded">
                            </div>
        ...
        <div class="row g-5 justify-content-center">
            <div class=" col-md-6 col-lg-6 col-xl-4 wow fadeIn" data-wow-delay=".3s">
                <div class="blog-item position-relative bg-light rounded">
                    <img src="img/blog-1.jpg" class="img-fluid w-100 rounded-top" alt="" height="100%">
                    <span class="position-absolute px-3 py-2 bg-multipixeldeep text-white rounded"
                          style="top: -25px; right: 20px;">Metting</span>
                    <div class="blog-btn d-flex justify-content-between position-relative px-3"
                        ...
                        <div class="blog-btn-icon btn bg-multipixeldeep px-3 py-3 ms-2 rounded-pill ">
                            ...
                            <div class="blog-icon-2 px-2">
                                <a href="" class="blog-btn-social pt-2 me-3 "><i
                    ...
                    <div class="blog-content text-center  px-3" style="margin-top: -25px;">
                        ...
                        <p class="py-2 text-multipixel">Lorem ipsum dolor sit amet elit. Sed efficitur quis purus ut
                            interdum. Aliquam dolor eget urna ultricies tincidunt libero sit amet</p>
                    </div>
                    <div
                        class="blog-coments d-flex justify-content-between px-4 py-2 border bg-multipixeldeep rounded-bottom">
                        <a href="" class="text-white"><small><i class="fas fa-share me-2 text-white"></i>5324
                                Share</small></a>
                        <a href="" class="text-white"><small><i class="fa fa-comments me-2 text-white"></i>5
                                Comments</small></a>
                    </div>
                </div>
            </div>
            <div class="col-md-6 col-lg-6 col-xl-4 wow fadeIn" data-wow-delay=".5s">
                <div class="blog-item position-relative bg-light rounded">
                    ...
                    <span class="position-absolute px-3 py-2 bg-multipixeldeep text-white rounded"
                          style="top: -25px; right: 20px;">Development</span>
                    <div class="blog-btn d-flex justify-content-between position-relative px-3"
                         style="margin-top: -75px;">
                        <div class="blog-icon btn bg-multipixeldeep px-2 rounded-pill py-1">
                            <a href="" class="btn text-white ">Read More</a>
            ...
            <div class="col-md-6 col-lg-6 col-xl-4 wow fadeIn" data-wow-delay=".7s">
                <div class="blog-item position-relative bg-light rounded">
                    ...
                    <span class="position-absolute px-3 py-2 bg-multipixeldeep text-white rounded"
                          style="top: -25px; right: 20px;">Mobile App</span>
                    <div class="blog-btn d-flex justify-content-between position-relative px-3"
                         style="margin-top: -75px;">
                        <div class="blog-icon btn bg-multipixeldeep px-2 rounded-pill py-1">
                            <a href="" class="btn text-white ">Read More</a>
        ...
        <div class="owl-carousel team-carousel wow fadeIn" data-wow-delay=".5s">
                ...
                <div class="team-content">
                    <div class="team-img-icon">
                        <div class="team-img rounded-circle">
                            <img src="img/team/boss.jpg" class="img-fluid w-100 rounded-circle" alt="">
                        </div>
                        ...
                        <div class="team-icon d-flex justify-content-center pb-4">
                            <a class="btn btn-square btn-secondary text-multipixel rounded-circle m-1" href=""><i
            ...
            <div class="rounded team-item">
                <div class="team-content">
                    <div class="team-img-icon">
                        <div class="team-img rounded-circle">
                            <img src="img/team/maruf.jpg" class="img-fluid w-100 rounded-circle" alt="">
                        </div>
                        <div class="team-name text-center py-3">
    ...
    <div class="container">
        <div class="text-center mx-auto pb-5 wow fadeIn" data-wow-delay=".3s" style="max-width: 600px;">
            ...
            <p class="mb-2">The contact form is currently inactive. Get a functional and working contact form with Ajax
                & PHP in a few minutes. Just copy and paste the files, add a little code and you're done.</p>
        </div>
        <div class="contact-detail position-relative p-3">
            <div class="row g-5 justify-content-center">
                <div class="col-xl-4 col-lg-6 wow fadeIn " data-wow-delay=".3s">
                    <div class="d-flex  p-2 rounded">
                        <div class="flex-shrink-0 btn-square bg-multipixel rounded-circle"
                             style="width: 50px; height: 50px;">
                            <i class="fas fa-map-marker-alt text-white"></i>
                        </div>
                        <div class="ms-4">
                            <span class="text-white" style="font-size: 20px">Address</span><br>
                            <span> <a href="https://goo.gl/maps/Zd4BCynmTb98ivUJ6"
                                      target="_blank">23 rank Str, NY</a></span>
    ...
    <div class="container pt-5 pb-4">
        <div class="row g-5">
            <div class="col-lg-5 col-md-6 col-sm-12">
                ...
                <p class="mt-3 text-light">Lorem ipsum dolor sit amet consectetur adipisicing elit. Soluta facere
                    delectus qui placeat inventore consectetur repellendus optio debitis.Lorem ipsum dolor sit amet consectetur adipisicing elit.</p>
            ...
            <div class="col-lg-2 col-md-6">
                ...
                <div class="mt-4 d-flex flex-column short-link">
                    <a href="about-us.html" class="mb-2 text-white"><i class="fas fa-angle-right text-multipixel me-2"></i>About
                        us</a>
                    <a href="service.html" class="mb-2 text-white"><i class="fas fa-angle-right text-multipixel me-2"></i>Our
                        Services</a>
                    <a href="project.html" class="mb-2 text-white"><i class="fas fa-angle-right text-multipixel me-2"></i>Our
                        Projects</a>
                    <a href="blog.html" class="mb-2 text-white"><i class="fas fa-angle-right text-multipixel me-2"></i>Latest
                        Blog</a>
                    <a href="client-comment.html" class="mb-2 text-white"><i class="fas fa-angle-right text-multipixel me-2"></i>Testimonial</a>
                </div>
            </div>
            <div class="col-lg-2 col-md-6">
                <a href="#" class="h3 text-multipixel">Help Link</a>
                <div class="mt-4 d-flex flex-column help-link">
                    <a href="" class="mb-2 text-white"><i class="fas fa-angle-right text-multipixel me-2"></i>Terms Of
                        use</a>
                    <a href="" class="mb-2 text-white"><i class="fas fa-angle-right text-multipixel me-2"></i>Privacy
                        Policy</a>
                    ...
                    <a href="contact.html" class="mb-2 text-white"><i
                            class="fas fa-angle-right text-multipixel me-2"></i>Contact</a>
                </div>
            </div>
            <div class="col-lg-3 col-md-6">
                <a href="#" class="h3 text-multipixel">Contact Us</a>
                <div class="text-white mt-4 d-flex flex-column contact-link">
                    <a href="#" class="pb-3 text-light border-bottom border-primary"><i
                            class="fas fa-map-marker-alt text-multipixel me-2"></i> 123 Street, New York, USA</a>
                    <a href="#" class="py-3 text-light border-bottom border-primary"><i
                            class="fas fa-phone-alt text-multipixel me-2"></i> +123 456 7890</a>
                    <a href="#" class="py-3 text-light border-bottom border-primary"><i
                            class="fas fa-envelope text-multipixel me-2"></i> info@exmple.con</a>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-6 text-center text-md-start">
                <span class="text-light"><a href="#" class="text-multipixel"><i
                            class="fas fa-copyright text-multipixel me-2"></i>multipixelstudio</a> , All right reserved 2023.</span>
            </div>
            <div class="col-md-6 text-center text-md-end">
                <span class="text-light">Designed By :<a href=""
                                                         class="text-multipixel"> VerseTech</a> Distributed By <a
                        href="">Golden Creative Ltd</a></span>
            </div>
        </div>
    </div>
</div>
...
<!-- Back to Top -->
<a href="#" class="btn bg-multipixel btn-square rounded-circle back-to-top"><i
    ...
    <div id="carouselId" class="carousel slide" data-bs-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
            <div class="carousel-item active">
                <img src="img/carousel-2.jpg" class="img-fluid" alt="First slide">
                <div class="carousel-caption">
                    <div class="container carousel-content">
                        ...
                        <a href="" class="me-2">
                            <button type="button"
                                    class="px-4 py-sm-3 px-sm-5 btn bg-multipixeldeep rounded-pill carousel-content-btn1 animated fadeInLeft">
                                Read More
                            </button>
                        </a>
                        <a href="" class="ms-2">
                            <button type="button"
                                    class="px-4 py-sm-3 px-sm-5 btn bg-multipixeldeep rounded-pill carousel-content-btn2 animated fadeInRight">
                                Contact Us
                            </button>
                        </a>
                    </div>
            ...
            <div class="carousel-item">
                <img src="img/carousel-1.jpg" class="img-fluid" alt="Second slide">
                <div class="carousel-caption">
                    <div class="container carousel-content">
                        <h6 class="text-white h4 animated fadeInUp">Best IT Solutions</h6>
