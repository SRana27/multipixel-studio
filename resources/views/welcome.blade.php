            ...
            <div class="carousel-item active">
                ...
                <div class="carousel-caption">
                    <div class="container carousel-content">
                        ...
                        <h1 class="text-white display-1 mb-4 animated fadeInRight">Yes atlast Our 1PC is comming Today </h1>
                ...
                <div class="col-lg-6 col-sm-12  wow fadeIn" data-wow-delay=".5s">
                    <div class=" rounded contact-form">
                        ...
                        <div class="text-start">
                            <button  class="btn text-white py-2 bg-multipixeldeep px-4" type="button">Send Message</button>
                        </div>
                    </div>
                </div>
            </div>
...
<!-- Back to Top -->
<a href="#" class="btn bg-multipixeldeep btn-square rounded-circle back-to-top"><i
