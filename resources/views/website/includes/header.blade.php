...
<div class="container-fluid bg-dark py-2 d-none d-md-flex">
    <div class="container">
        <div class="d-flex justify-content-between topbar">
            ...
            <div class="top-link">
                <a href="" title="discord" class="bg-light nav-fill btn btn-sm-square rounded-circle"><i class="bi bi-discord text-primary"></i></a>
...
{{--                <h1 class="text-white fw-bold d-block">Multipixel<span class="text-secondary">Studio</span> </h1>--}}
