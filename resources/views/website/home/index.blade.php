        ...
        <div id="carouselId" class="carousel slide" data-bs-ride="carousel">
            ...
            <div class="carousel-inner" role="listbox">
                <div class="carousel-item active">
                    <img src="{{asset('/')}}website-assets/img/carousel-1.jpg" class="img-fluid" alt="First slide">
                ...
                <div class="carousel-item">
                    <img src="{{asset('/')}}website-assets/img/carousel-2.jpg" class="img-fluid" alt="Second slide">
                    <div class="carousel-caption">
                        <div class="container carousel-content">
                            <h6 class="text-secondary h4 animated fadeInUp">Best IT Solutions</h6>
            ...
            <div class="row g-5 justify-content-center">
                <div class="col-lg-6 col-xl-4 wow fadeIn" data-wow-delay=".3s">
                    <div class="blog-item position-relative bg-light rounded">
                        <img src="{{asset('/')}}website-assets/img/blog-1.jpg" class="img-fluid w-100 rounded-top" alt="">
                ...
                <div class="row g-5 justify-content-center">
                    <div class="col-xl-4 col-lg-6 wow fadeIn" data-wow-delay=".3s">
                        <div class="d-flex bg-light p-2 rounded">
                            ...
                            <div class="ms-2">
                                <span class="text-dark" style="font-size: 20px">Address</span><br>
                    ...
                    <div class="col-xl-4 col-lg-6 wow fadeIn" data-wow-delay=".5s">
                        <div class="d-flex bg-light p-2 rounded">
                            ...
                            <div class="ms-2">
                                <span class="text-dark" style="font-size: 20px">Call Us</span><br>
                    ...
                    <div class="col-xl-4 col-lg-6 wow fadeIn" data-wow-delay=".7s">
                        <div class="d-flex bg-light p-2 rounded">
                            ...
                            <div class="ms-2">
                                <span class="text-dark" style="font-size: 20px">Email Us</span><br>
